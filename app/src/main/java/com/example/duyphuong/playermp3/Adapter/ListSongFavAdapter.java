...
public class ListSongFavAdapter extends BaseAdapter{

    private ArrayList<SongModel> arrayList = new ArrayList<>();
    private Context context;

    public ListSongFavAdapter(Context context, ArrayList<SongModel> arrayList) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        View row = layoutInflater.inflate(R.layout.list_songs_fav_item,parent,false);
